...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    private lateinit var emegencyNumber: String
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val locationManager =
            getSystemService(Context.LOCATION_SERVICE) as LocationManager // Getting location service instance
        val enabled = locationManager
            .isProviderEnabled(LocationManager.GPS_PROVIDER)

        emegencyNumber = PreferenceManager.getDefaultSharedPreferences(this)
            .getString("call_number", "76492278")
...
// Vibrate for 500 milliseconds
            ...
            builder.setTitle("Dismiss the application if it was opened by accident")
    ...
    fun sendAnSMS() {
        val listString = PreferenceManager.getDefaultSharedPreferences(this)
            .getString("text_numbers", "[]")
        val arr = JSONArray(listString)
        for (i in 0..arr.length() - 1) {
            val smsManager = SmsManager.getDefault()
            smsManager.sendTextMessage(
                arr.getString(i),
                null,
                "Please help I am at https://maps.google.com/maps?q=${location.latitude},${location.longitude}",
                null,
                null
            )
